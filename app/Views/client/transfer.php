...
<div class="row">
                ...
                <form action="<?= base_url('/transfer') ?>" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <input 
                            ...
                            id="receiver_phone" 
                            name="receiver_phone" 
                            placeholder="Numéro du destinataire (ex: 0331234567)"
                    ...
                    <div class="mb-4">
                        <label for="amount" class="form-label">
                            <i class="fas fa-money-bill"></i> Montant à transférer (FCFA)
                        </label>
                    ...
                    <div class="alert alert-light border mb-4">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <strong id="total_display" class="text-danger">0 FCFA</strong>
                        </div>
                        <div class="d-flex justify-content-between">
                            <strong>Destinataire recevra:</strong>
                            <strong id="receiver_display" class="text-success">0 FCFA</strong>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 form-check">
                        ...
                        <div class="invalid-feedback">
                            Veuillez confirmer le transfert
                        </div>
                    </div>
    ...
    <!-- Informations sur les frais de transfert -->
    <div class="col-md-4 col-lg-6">
        <div class="card bg-light mb-3">
            <div class="card-header bg-info text-white">
                <h6 class="mb-0">
                    <i class="fas fa-percentage"></i> Barème des frais de transfert
                </h6>
            </div>
            <div class="card-body">
...
<script>
    ...
    document.getElementById('amount').addEventListener('input', function() {
        ...
        document.getElementById('receiver_display').textContent = formatter.format(receiver);
    });
</script>
